            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item item4" data-tab="tab5">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" aria-expanded="false">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid " style="background-color:#17212C;color: white; min-height:calc(100vh - 149px)">
                ...
                <div id="tab3" class="tab-content">
                    <h2>Download Teacher Passwords</h2>
                    <br>
                    <div class="row main-content">
                                ...
                                <button class="px-0 card-link" type="submit" name="download_passwords" style="background-color: transparent;border:0; text-align: left; outline: none;">
                                    <div class=" card mb-3 d-flex justify-content-center align-items-center">
                                        ...
                                        <div class="row g-0">
                                            ...
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    <h5 class="card-title" style="font-size: 25px;">Download Teacher Passwords</h5>
                ...
                <div id="tab4" class="tab-content">
                    <h2>Teacher Login ON/OFF</h2>
                    <br>
                    <div class="row main-content">

                        <form method="POST">
                            <label>Click ON to activate Teacher Login </label>
                           
                            <button class="btn btn-success" type="submit" name="teacher_on_off" value="on" style="background:green;">ON</button>
                            <br>
                            <br>
                            <label>Click OFF to deactivate Teacher Login </label>
